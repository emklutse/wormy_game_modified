...
def main():
    ...
    pygame.display.set_caption('Wormy 2.0 by Emmanuel')
...
def runGame():
    ...
    # Start the orange in a random place.
    ...
    while True: # main game loop
        ...
        if wormCoords[HEAD]['x'] == apple['x'] and wormCoords[HEAD]['y'] == apple['y']:
         ...
         # check if worm has eaten an orange
        if wormCoords[HEAD]['x'] == orange['x'] and wormCoords[HEAD]['y'] == orange['y']:
            # don't remove worm's tail segment
            orange = getRandomLocation() # set a new apple somewhere
        else:
            del wormCoords[-1] # remove worm's tail segment
...
def showStartScreen():
    ...
    titleSurf1 = titleFont.render('Wormy 2.0!', True, WHITE, DARKGREEN)
    titleSurf2 = titleFont.render('Wormy 2.0!', True, GREEN)
